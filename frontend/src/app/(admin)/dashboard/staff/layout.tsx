    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      >
        ...
        <div className="p-6 border-t border-gray-100">
          {isCollapsed ? (
            <div
              title={`Acesso: ${user.cargo || "Bibliotecário(a)"}`}
  ...
  return (
    <Link
      ...
      className={`flex items-center gap-4 p-4 rounded-xl transition-all ${
        active ? "text-denin font-bold" : "text-gray-700 hover:text-denin"
...
//   const [openCirculacao, setOpenCirculacao] = useState(true);
//   const [openEmprestimoMenu, setOpenEmprestimoMenu] = useState(false); // Novo submenu
//   const [openReservaMenu, setOpenReservaMenu] = useState(false);
