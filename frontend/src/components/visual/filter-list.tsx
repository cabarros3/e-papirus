...
export default function FilterList({
  ...
  // Define quais itens serão renderizados com base no estado "Ver mais"
  const displayedItems = showAll ? items : items.slice(0, limit);

  return (
    <ul className="space-y-1 mt-2">
      {/* Mensagem caso não existam itens para o filtro */}
      {items.length === 0 && (
      ...
      {/* Renderização da lista de botões */}
